...
do_analysis <- function(region, agent, nsamples) {
...
# 
# tic()
# newdata = as.data.frame(as.matrix(subset(covariates, c(1:5))))
# toc()
# 
# rm(newdata)
# 
...
pwalk(list(
      ...
      possibly(do_analysis, print("There is some error check again"),quiet=T))
